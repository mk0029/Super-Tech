              ...
              <div className="col-md-9">
                ...
                <div
                  ...
                  <p className="ff_jakarta fw-normal fs_sm text_black opacity08 mb-0 pt-2 mt-1">
                    ...
                    <span className="d-block">
                      ...
                      confidentiality of any credentials or access provided to
                      the Company to perform the services.
                    </span>{" "}
                    The Client acknowledges that the Company's recommendations
                    and advice are based on the information provided by the
                ...
                <div
                  ...
                  <p className="ff_jakarta fw-normal fs_sm text_black opacity08 mb-0 pt-2 mt-1">
                    ...
                    provision of services, confidential information may be
                    shared. Both parties agree to keep such information
                    confidential and not disclose it to third parties, except as
                    required by law.
                  </p>
                </div>
                <div
                  ...
                  <p className="ff_jakarta fw-normal fs_sm text_black opacity08 mb-0 pt-2 mt-1">
                    <span className="d-block">
                      ...
                      services provided, shall be limited to the amount paid by
                      the Client for the specific services.
                    </span>{" "}
                ...
                <div
                  ...
                  <p className="ff_jakarta fw-normal fs_sm text_black opacity08 mb-0 pt-2 mt-1">
                    ...
                    related to the Client's use of the services or breach of
                    these Terms.
                  </p>
                </div>
                <div
