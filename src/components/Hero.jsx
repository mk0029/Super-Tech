...
import { ReactComponent as HeroImg } from "../assets/img/svg/hero-img.svg";
        ...
        animations: [
          {
            elements: {
              ejrWTlCdF9N37: {
                transform: {
                  data: { t: { x: -100.433739, y: -135.088997 } },
                  keys: {
                    o: [
                      {
                        t: 1300,
                        v: { x: 99.90785, y: 210.731001, type: "cusp" },
                      },
                      {
                        t: 3000,
                        v: { x: 99.17646, y: 140.54366, type: "cusp" },
                      },
                    ],
                  },
                },
              ...
              ejrWTlCdF9N38: {
                transform: {
                  data: { t: { x: -100.433739, y: -163.372238 } },
                  keys: {
                    o: [
                      {
                        t: 700,
              ...
              ejrWTlCdF9N39: {
                transform: {
                  data: { t: { x: -100.433739, y: -191.229187 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 99.90785, y: 210.731001, type: "cusp" } },
                      {
                        t: 1300,
                        v: { x: 99.17646, y: 140.54366, type: "cusp" },
                      },
              ...
              ejrWTlCdF9N67: {
                transform: {
                  data: { t: { x: -449.802887, y: -134.254719 } },
                  keys: {
                    o: [
                      {
                        t: 1000,
                        v: { x: 449.862107, y: 206.875401, type: "cusp" },
                      },
                      {
                        t: 3000,
                        v: { x: 449.862107, y: 105.537, type: "cusp" },
                      },
                    ],
                  },
                },
              ...
              ejrWTlCdF9N68: {
                transform: {
                  data: { t: { x: -449.802887, y: -162.540306 } },
                  keys: {
                    o: [
                      {
                        t: 500,
              ...
              ejrWTlCdF9N69: {
                transform: {
                  data: { t: { x: -449.802887, y: -190.394302 } },
                  keys: {
                    o: [
                      {
                        t: 0,
              ...
              ejrWTlCdF9N74: {
                transform: {
                  data: { t: { x: -421.893005, y: -275.522003 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 421.892, y: 265.022, type: "cusp" } },
                      { t: 1500, v: { x: 421.892, y: 302.456, type: "cusp" } },
                      { t: 3000, v: { x: 294.547, y: 376.469, type: "cusp" } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N75: {
                transform: {
                  data: { t: { x: -397, y: -267.5 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 397.067, y: 249.715, type: "cusp" } },
                      { t: 700, v: { x: 397.067, y: 287.164, type: "cusp" } },
                      {
                        t: 3000,
                        v: {
                          x: 295.97720833333335,
                          y: 345.97979166666664,
                          a: 149.80841392975165,
                        },
                      },
                    ],
                  },
              ...
              ejrWTlCdF9N125: {
                transform: {
                  data: { t: { x: -89.248158, y: -351.811203 } },
                  keys: {
                    o: [
                      {
                        t: 1110,
                        v: { x: 89.247553, y: 432.20099, type: "cusp" },
                      },
                      {
                        t: 2900,
                        v: { x: 89.247553, y: 348.537002, type: "cusp" },
                      },
                    ],
                  },
                },
              ...
              ejrWTlCdF9N126: {
                transform: {
                  data: { t: { x: -89.248158, y: -380.094635 } },
                  keys: {
                    o: [
                      {
                        t: 700,
              ...
              ejrWTlCdF9N127: {
                transform: {
                  data: { t: { x: -89.248158, y: -407.948441 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 89.247553, y: 432.20099, type: "cusp" } },
                      {
                        t: 1500,
                        v: { x: 89.247553, y: 348.537002, type: "cusp" },
                      },
              ...
              ejrWTlCdF9N140: {
                transform: {
                  data: { t: { x: -457.851746, y: -334.656998 } },
                  keys: {
                    o: [
                      { t: 1300, v: { x: 456.9545, y: 411.599, type: "cusp" } },
                      { t: 2900, v: { x: 456.227, y: 336.859, type: "cusp" } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N141: {
                transform: {
                  data: { t: { x: -457.851746, y: -362.940445 } },
                  keys: {
                    o: [
                      { t: 800, v: { x: 456.9545, y: 411.599, type: "cusp" } },
                      { t: 2200, v: { x: 456.227, y: 336.859, type: "cusp" } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N142: {
                transform: {
                  data: { t: { x: -457.851746, y: -390.797699 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 456.9545, y: 411.599, type: "cusp" } },
                      { t: 1700, v: { x: 456.227, y: 336.859, type: "cusp" } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N181: {
                transform: {
                  data: { t: { x: -351, y: -363.981995 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 405.316, y: 422.582002, type: "cusp" } },
                      { t: 1900, v: { x: 351, y: 390.783, type: "cusp" } },
                      { t: 3000, v: { x: 351, y: 356.4694166666667, a: -90 } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N182: {
                transform: {
                  data: { t: { x: -326, y: -386.5 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 405.316, y: 453.222, type: "cusp" } },
                      { t: 2000, v: { x: 326, y: 406.091, type: "cusp" } },
                      { t: 3000, v: { x: 326, y: 372.06100000000004, a: -90 } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N183: {
                transform: {
                  data: { t: { x: -242, y: -386.5 } },
                  keys: {
                    o: [
                      {
                        t: 100,
                        v: { x: 145.556001, y: 459.447, type: "cusp" },
                      },
                      { t: 1700, v: { x: 242, y: 406.091, type: "cusp" } },
                      { t: 3000, v: { x: 242, y: 371.33178571428573, a: -90 } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N184: {
                transform: {
                  data: { t: { x: -217, y: -386.5 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 137.310001, y: 436.044, type: "cusp" } },
                      { t: 1900, v: { x: 217, y: 390.783, type: "cusp" } },
                      { t: 3000, v: { x: 217, y: 353.35, type: "cusp" } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N185: {
                transform: {
                  data: { t: { x: -126, y: -294.5 } },
                  keys: {
                    o: [
                      { t: 0, v: { x: 126, y: 271.872, type: "cusp" } },
                      { t: 1500, v: { x: 126, y: 309.305, type: "cusp" } },
                      { t: 3000, v: { x: 186, y: 348.537002, type: "cusp" } },
                    ],
                  },
                },
              },
              ejrWTlCdF9N191: {
                transform: {
                  data: {
                    o: { x: 357.044495, y: 183.961998, type: "corner" },
                    t: { x: -357.044495, y: -183.961998 },
                  },
                  keys: {
                    r: [
                      { t: 60, v: 0 },
            ...
            s: "",
          },
        ],
        options: "MHDAxMDg4MmY4MDgxNmAU3ZjgxVTJmQzQ3MmYM3OUI3YzZlNzEyZjhhC",
      },
      "__SVGATOR_PLAYER__",
      window,
      document
